...
$(document).ready(function(){
    ...
    for(let i=1; i<=100; i++){
        ...
        // appending cells (like matrix traversal) //
        for(let i=1; i<=100; i++){
        ...
        // making align icons selectable //
        $(".align-icon").click(function(){
            $(".align-icon.selected").removeClass("selected");
            $(this).addClass("selected");
        })

        // making format icons selectable //
        $(".style-icon").click(function(){
            $(this).toggleClass("selected");
        })

        // making input cells selectable //
        ...
        // making column name and row name container scrollable //
...
function updateCell(property, value, defaultPossible){
    $(".input-cell.selected").each(function(){
        ...
        if(defaultPossible && (JSON.stringify(cellData[selectedSheet][rowId][colId]) === JSON.stringify(defaultProperties))){
            ...
            if(object.keys(cellData[selectedSheet][rowId][colId]).length == 0){
